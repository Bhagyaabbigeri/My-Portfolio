...
const projects: ProjectItem[] = [
  ...
  {
    id: "neosynapse-dashboard",
    num: "04",
    title: "NeoSynapse Dashboard v2.1",
    desc: "A comprehensive Neural Analytics interface featuring real-time brain network mapping, connectivity matrices, and multi-lobe signal synchronization tracking.",
    tags: ["Neural Analytics", "UI/UX", "Data Visualization", "Brain Mapping"],
    link: "https://github.com/Bhagyaabbigeri/My_Portfolio/blob/main/public/projects/synapse.png",
    language: "Design & Dev",
    langColor: "#F1E05A",
    icon: Zap,
    accent: "from-purple-500/30 to-cyan-400/10",
