...
const projects: ProjectItem[] = [
  {
    ...
    desc: "A high-fidelity Space Situational Awareness (SSA) platform for real-time orbital tracking and threat analysis. Features high-precision SGP4/SDP4 propagation for 2,000+ satellites, automated conjunction monitoring with customizable screening thresholds, and velocity diagnostics. Includes advanced risk layers for debris clouds and chain probabilities, ground visibility link diagnostics, geodetic coordinate mapping, and complex mission scenarios like Hubble drag compensation.",
    tags: ["Python", "Flask", "SGP4", "Three.js", "Socket.IO", "Orbital Mechanics", "Space Tech", "Telemetry"],
